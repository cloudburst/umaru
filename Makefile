...
#---------------------------------------------------------------------------------
TARGET		:=	release/umaru
BUILD		:=	build
SOURCES		:=	source source/images
DATA		:=	data
INCLUDES	:=	include 

APP_TITLE		:= Himouto! Umaru-chan
APP_DESCRIPTION	:= Umaru in Dolby Digital 3D
APP_AUTHOR		:= cloud
ICON			:= icon.png
...
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= $(CTRULIB) sf2dlib/libsf2d/
...
export OFILES	:=	$(addsuffix .o,$(BINFILES)) \
	$(CPPFILES:.cpp=.o) $(IMAGES:.c=.o) $(CFILES:.c=.o) $(SFILES:.s=.o)
